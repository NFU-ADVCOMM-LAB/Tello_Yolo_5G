...
class Tello:
    ...
    def __init__(self, local_ip, local_port, imperial=False, command_timeout=.3, tello_ip="172.16.0.1",
                 tello_port=2000):
        """
        ...
        self.local_video_addr = ("192.168.0.2",3000)  # IP address for receiving video stream
        self.last_height = 0
        self.socket.bind((local_ip, local_port))
        self.stopEvent = None #add
        
        self.stopEvent = threading.Event() #add
        ...
        self.socket_video.bind(self.local_video_addr)
    ...
    def _receive_video_thread(self):
        ...
        while not self.stopEvent.is_set():
            try:
                packet_data, ip = self.socket_video.recvfrom(2048)
    ...
    def close(self):
        print("[INFO] Core closing...")
        self.stopEvent.set()
        self.receive_thread.join()
        print("[INFO] Core closed!!")